...
public class ConsoleProxy {
	 ...
	 * @return Returns either the text of the debug console if it's open or the main console.
	 */
	...
	/**
	 * Sets the background color of either the main console or the debug console.
	 * @param color Color to be set.
	 */
